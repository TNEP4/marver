...
export function goalText(packet: JobPacket): string {
  return [
    ...
    '- HARD LENGTH CAP: your reply must be no longer than about TWICE the owner\'s comment, and never',
    '  more than 3 sentences unless their comment was itself long. One-line ask -> one-line reply.',
    '  No inventory of everything you did (the canvas shows the work); no caveat paragraphs - fold a',
    '  genuine limitation into one short clause or drop it.',
